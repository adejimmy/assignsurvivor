...
//    }
//
//    public static Survivors personGenerator() throws IOException {
//        Survivors person = new Survivors();
//        buildGender(person);
...
//    }
//
//    private static void buildGender(Survivors person) throws IOException {
...
//    }
//
//    private static Resources buildAddress() throws IOException {
//        Resources address = new Resources();
...
//                    address.setLocation(new Location(doubleGenerator(48.819918, 48.900552), doubleGenerator(2.25929, 2.4158559)));
//                    break;
//                case 1:
//                    address.setCity("Nantes");
//                    address.setZipcode("44000");
//                    address.setLocation(new Location(doubleGenerator(47.157742, 47.270729), doubleGenerator(-1.623467, -1.471032)));
//                    break;
//                case 2:
//                    address.setCity("Cergy");
//                    address.setZipcode("95000");
//                    address.setLocation(new Location(doubleGenerator(49.019583, 49.059419), doubleGenerator(2.003001, 2.090892)));
//                    break;
//                default:
...
//                    address.setLocation(new Location(doubleGenerator(51.444014, 51.607633), doubleGenerator(-0.294245, 0.064184)));
//                    break;
//                case 1:
//                    address.setCity("Plymouth");
//                    address.setZipcode("5226");
//                    address.setLocation(new Location(doubleGenerator(50.345272, 50.434797), doubleGenerator(-4.190161, -4.034636)));
//                    break;
//                case 2:
//                    address.setCity("Liverpool");
//                    address.setZipcode("86767");
//                    address.setLocation(new Location(doubleGenerator(53.345346, 53.496339), doubleGenerator(-3.047485, -2.564774)));
//                    break;
//                default:
//                    System.err.println("buildAddress ->" + result.intValue());
//                    break;
...
//                    address.setLocation(new Location(doubleGenerator(52.364796, 52.639827), doubleGenerator(13.115778, 13.769465)));
//                    break;
//                case 1:
//                    address.setCity("Bonn");
//                    address.setZipcode("0099");
//                    address.setLocation(new Location(doubleGenerator(50.649948, 50.766049), doubleGenerator(7.025075, 7.214589)));
//                    break;
//                case 2:
//                    address.setCity("Munich");
//                    address.setZipcode("45445");
//                    address.setLocation(new Location(doubleGenerator(48.081337, 48.238441), doubleGenerator(11.371548, 11.711437)));
//                    break;
//                default:
//                    System.err.println("buildAddress ->" + result.intValue());
//                    break;
...
//                    address.setLocation(new Location(doubleGenerator(41.797211, 41.980805), doubleGenerator(12.373950, 12.601393)));
//                    break;
//                case 1:
//                    address.setCity("Turin");
//                    address.setZipcode("10100");
//                    address.setLocation(new Location(doubleGenerator(45.007912, 45.122125), doubleGenerator(7.593528, 7.747337)));
//                    break;
//                case 2:
//                    address.setCity("Ischia");
//                    address.setZipcode("80100");
//                    address.setLocation(new Location(doubleGenerator(40.704982, 40.758477), doubleGenerator(13.859360, 13.953002)));
//                    break;
//                default:
//                    System.err.println("buildAddress ->" + result.intValue());
//                    break;
...
//    }
//
//    private static String generateCountry(Resources address) {
//
